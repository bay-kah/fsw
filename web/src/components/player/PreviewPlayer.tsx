...
export default function PreviewPlayer({
  ...
  return (
    <div
      className={cn(
        "flex size-full items-center justify-center rounded-sm bg-background_alt text-primary md:rounded-2xl",
        className,
      )}
    >
      {t("noPreviewFound")}
...
function PreviewVideoPlayer({
  ...
  return (
    <div
      ref={visibilityRef}
      className={cn(
        "relative flex w-full justify-center overflow-hidden rounded-sm bg-black md:rounded-2xl",
    ...
    >
      ...
      {cameraPreviews && !currentPreview && (
        <div className="absolute inset-0 flex items-center justify-center rounded-sm bg-background_alt text-primary dark:bg-black md:rounded-2xl">
...
function PreviewFramesPlayer({
  ...
  return (
    ...
    >
      <img
        ref={imgRef}
        className={`size-full rounded-sm bg-black object-contain md:rounded-2xl`}
        loading="lazy"
        onLoad={onImageLoaded}
      />
      {previewFrames?.length === 0 && (
        <div className="-y-translate-1/2 align-center absolute inset-x-0 top-1/2 rounded-sm bg-background_alt text-center text-primary dark:bg-black md:rounded-2xl">
